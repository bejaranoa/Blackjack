...
class App(ctk.CTk):
    ...
    def start(self):
        ...
        button = ctk.CTkButton(self.menu_frame, text="Play", 
            command=self.play_button, width=140, height=40, 
            font=('Impact', 25))
    ...
    def check_player_score(self):
        '''checks if the player's score exceeds 21 and handles bust scenario'''
    ...
    , font=('Helvetica bold', 25))
        ...
        self.dealer_label = ctk.CTkLabel(self.frame, 
                        ...
                        width=0.1, font=('Helvetica bold', 25))
 ...
 command=self.increment_player_score, width=140, height=40, 
 font=('Impact', 25))
...
command=self.increment_dealer_score, width=140, height=40, 
font=('Impact', 25))
    ...
    def end_game_buttons(self):
        ...
        command=self.restart_main, master=self.status_frame, width=140, 
    ...
    def help_button(self):
        ...
        go_back = ctk.CTkButton(text="Go back", 
                    command=self.back1, master=self.help_frame1, width=140, 
                    height=40, font=('Impact', 25))
    ...
    def pag2(self):
        ...
        hit_ex=ctk.CTkLabel(text='By clicking the hit button,\nyour hand value'
                ' will increase', font=('Helvetica bold', 20),
...
'not be dealt any more cards', font=('Helvetica bold', 20), 
master=self.help_frame2)
